...
public class ProgressHUD: UIView {
    ...
    public var delegate: ProgressHUDDelegate?
    ...
    public class func show(addedToView view: UIView, animated: Bool) -> ProgressHUD {
    ...
    public class func hudForView(_ view: UIView) -> ProgressHUD? {
